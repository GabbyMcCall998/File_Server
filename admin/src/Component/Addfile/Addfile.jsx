import './Addfile.css';
import upload_icon from '../../assets/icons8-upload-94.png';
import video_icon from '../../assets/icons8-video-94.png'
import audio_icon from '../../assets/icons8-audio-100.png'
import document_icon from '../../assets/icons8-document-94.png'
    ...
    const Add_File = async () => {
        ...
        try {
            ...
            if (uploadData.success) {
                ...
                const addFileResponse = await fetch("http://localhost:5000/addfile", {
                    method: 'POST',
                    headers: {
